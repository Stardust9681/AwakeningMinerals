...
using AwakeningMinerals.Projectiles.ElementalsBiome.AstralMoonBiome;
...
{
	public class AstralMoonSandTile : ModTile
	{
		...
		public override void SetDefaults() {
			...
			dustType = ModContent.DustType<AstralMoonDust>();
			//Drop the ExampleSandBlock
			drop = ModContent.ItemType<Items.AstralMoon.AstralMoonSand>();
			//Make ExampleCactus able to grow on this tile
			SetModCactus(new AstralMoonCactusTile());
		}
		...
		public override bool TileFrame(int i, int j, ref bool resetFrame, ref bool noBreak) {
			...
			if (canFall) {
				...
				int projectileType = ModContent.ProjectileType<AstralMoonBiomeSandProj>();

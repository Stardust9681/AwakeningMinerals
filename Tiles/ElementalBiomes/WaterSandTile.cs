...
using AwakeningMinerals.Projectiles.ElementalsBiome.WaterBiome;
...
{
	public class WaterSandTile : ModTile
	{
		...
		public override void SetDefaults() {
			...
			drop = ModContent.ItemType<Items.Water.WaterSand>();
			//Make ExampleCactus able to grow on this tile
			SetModCactus(new WaterCactusTile());
		}
		...
		public override bool TileFrame(int i, int j, ref bool resetFrame, ref bool noBreak) {
			...
			if (canFall) {
				...
				int projectileType = ModContent.ProjectileType<WaterBiomeSandProj>();

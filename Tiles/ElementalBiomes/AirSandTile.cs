...
using AwakeningMinerals.Projectiles.ElementalsBiome.AirBiome;
...
{
	public class AirSandTile : ModTile
	{
		...
		public override void SetDefaults() {
			...
			dustType = ModContent.DustType<AirDust>();
			//Drop the ExampleSandBlock
			drop = ModContent.ItemType<Items.Air.AirSand>();
			//Make ExampleCactus able to grow on this tile
			SetModCactus(new AirCactusTile());
		}
		...
		public override bool TileFrame(int i, int j, ref bool resetFrame, ref bool noBreak) {
			...
			if (canFall) {
				...
				int projectileType = ModContent.ProjectileType<AirBiomeSandProj>();
		...
		public override int SaplingGrowthType(ref int style) {
			style = 1;
			return ModContent.TileType<AirSaplingTile>();
		}
	}
}
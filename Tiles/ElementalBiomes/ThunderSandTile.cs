...
using AwakeningMinerals.Projectiles.ElementalsBiome.ThunderBiome;
...
{
	public class ThunderSandTile : ModTile
	{
		...
		public override void SetDefaults() {
			...
			dustType = ModContent.DustType<ThunderDust>();
			//Drop the ExampleSandBlock
			drop = ModContent.ItemType<Items.Thunder.ThunderSand>();
			//Make ExampleCactus able to grow on this tile
			SetModCactus(new ThunderCactusTile());
		}
		...
		public override bool TileFrame(int i, int j, ref bool resetFrame, ref bool noBreak) {
			...
			if (canFall) {
				...
				int projectileType = ModContent.ProjectileType<ThunderBiomeSandProj>();
		...
		public override int SaplingGrowthType(ref int style) {
			style = 1;
			return ModContent.TileType<ThunderSaplingTile>();
		}
	}
}
...
using AwakeningMinerals.Projectiles.ElementalsBiome.IceBiome;
...
{
	public class IceSandTile : ModTile
	{
		...
		public override void SetDefaults() {
			...
			drop = ModContent.ItemType<Items.Ice.IceSand>();
			//Make ExampleCactus able to grow on this tile
			SetModCactus(new IceCactusTile());
		}
		...
		public override bool TileFrame(int i, int j, ref bool resetFrame, ref bool noBreak) {
			...
			if (canFall) {
				...
				int projectileType = ModContent.ProjectileType<IceBiomeSandProj>();
		...
		public override int SaplingGrowthType(ref int style) {
			style = 1;
			return ModContent.TileType<IceSaplingTile>();
		}
	}
}
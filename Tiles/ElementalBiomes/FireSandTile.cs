...
using AwakeningMinerals.Projectiles.ElementalsBiome.FireBiome;
...
{
	public class FireSandTile : ModTile
	{
		...
		public override void SetDefaults() {
			...
			dustType = ModContent.DustType<FireDust>();
			//Drop the ExampleSandBlock
			drop = ModContent.ItemType<Items.Fire.FireSand>();
			//Make ExampleCactus able to grow on this tile
			SetModCactus(new FireCactusTile());
		}
		...
		public override bool TileFrame(int i, int j, ref bool resetFrame, ref bool noBreak) {
			...
			if (canFall) {
				...
				int projectileType = ModContent.ProjectileType<FireBiomeSandProj>();
		...
		public override int SaplingGrowthType(ref int style) {
			style = 1;
			return ModContent.TileType<FireSaplingTile>();
		}
	}
}
...
using AwakeningMinerals.Projectiles.ElementalsBiome.LightBiome;
...
{
	public class LightSandTile : ModTile
	{
		...
		public override void SetDefaults() {
			...
			dustType = ModContent.DustType<LightDust>();
			//Drop the ExampleSandBlock
			drop = ModContent.ItemType<Items.Light.LightSand>();
			//Make ExampleCactus able to grow on this tile
			SetModCactus(new LightCactusTile());
		}
		...
		public override bool TileFrame(int i, int j, ref bool resetFrame, ref bool noBreak) {
			...
			if (canFall) {
				...
				int projectileType = ModContent.ProjectileType<LightBiomeSandProj>();
		...
		public override int SaplingGrowthType(ref int style) {
			style = 1;
			return ModContent.TileType<LightSaplingTile>();
		}
	}
}
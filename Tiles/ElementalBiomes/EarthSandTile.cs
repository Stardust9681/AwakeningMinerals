...
using AwakeningMinerals.Projectiles.ElementalsBiome.EarthBiome;
...
{
	public class EarthSandTile : ModTile
	{
		...
		public override void SetDefaults() {
			...
			dustType = ModContent.DustType<EarthDust>();
			//Drop the ExampleSandBlock
			drop = ModContent.ItemType<Items.Earth.EarthSand>();
			//Make ExampleCactus able to grow on this tile
			SetModCactus(new EarthCactusTile());
		}
		...
		public override bool TileFrame(int i, int j, ref bool resetFrame, ref bool noBreak) {
			...
			if (canFall) {
				...
				int projectileType = ModContent.ProjectileType<EarthBiomeSandProj>();

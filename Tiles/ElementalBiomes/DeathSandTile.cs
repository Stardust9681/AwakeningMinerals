...
using AwakeningMinerals.Projectiles.ElementalsBiome.DeathBiome;
...
{
	public class DeathSandTile : ModTile
	{
		...
		public override void SetDefaults() {
			...
			dustType = ModContent.DustType<DeathDust>();
			//Drop the ExampleSandBlock
			drop = ModContent.ItemType<Items.Death.DeathSand>();
			//Make ExampleCactus able to grow on this tile
			SetModCactus(new DeathCactusTile());
		}
		...
		public override bool TileFrame(int i, int j, ref bool resetFrame, ref bool noBreak) {
			...
			if (canFall) {
				...
				int projectileType = ModContent.ProjectileType<DeathBiomeSandProj>();

...
namespace AwakeningMinerals.Tiles
{
	...
	public class AncientHerb : ModTile
	{
		...
		public override bool Drop(int i, int j)
		{
			...
			if (stage == PlantStage.Grown)
				Item.NewItem(new Vector2(i, j).ToWorldCoordinates(), ModContent.ItemType<AncientSeed>());
				Item.NewItem(new Vector2(i, j).ToWorldCoordinates(), ModContent.ItemType<AncientFlower>(), Main.rand.Next(1, 5));

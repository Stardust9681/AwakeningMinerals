...
{
	public class ElementalDragonTongueProj8 : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Water Blace Elemental DragonTongue");
		}
		...
		public override void AI()
		{
            ...
            {
                Dust dust = Dust.NewDustDirect(projectile.position, projectile.height, projectile.width, ModContent.DustType<WaterWeaponDust>(),

...
{
	public class ElementalDragonTongueProj6 : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Light Blace Elemental DragonTongue");
		}
		...
		public override void AI()
		{
            ...
            {
                Dust dust = Dust.NewDustDirect(projectile.position, projectile.height, projectile.width, ModContent.DustType<LightWeaponDust>(),

...
{
	public class ElementalDragonTongueProj2 : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Death Blace Elemental DragonTongue");
		}
		...
		public override void AI()
		{
            ...
            {
                Dust dust = Dust.NewDustDirect(projectile.position, projectile.height, projectile.width, ModContent.DustType<DeathWeaponDust>(),

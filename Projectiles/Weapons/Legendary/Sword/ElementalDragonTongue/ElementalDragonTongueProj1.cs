...
{
	public class ElementalDragonTongueProj1 : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Air Blace Elemental DragonTongue");
		}
		...
		public override void AI()
		{
            ...
            {
                Dust dust = Dust.NewDustDirect(projectile.position, projectile.height, projectile.width, ModContent.DustType<AirWeaponDust>(),

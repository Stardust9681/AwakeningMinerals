...
namespace AwakeningMinerals.Projectiles.ElementalsBiome.ThunderBiome
{
	public class ThunderBiomeSandProj : ModProjectile
	{
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Thunder Sand Ball");
		...
		public override void SetDefaults() {
			...
			tileType = ModContent.TileType<ThunderSandTile>();

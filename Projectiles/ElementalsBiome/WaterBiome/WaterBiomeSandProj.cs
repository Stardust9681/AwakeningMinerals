...
namespace AwakeningMinerals.Projectiles.ElementalsBiome.WaterBiome
{
	public class WaterBiomeSandProj : ModProjectile
	{
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Water Sand Ball");
		...
		public override void SetDefaults() {
			...
			tileType = ModContent.TileType<WaterSandTile>();

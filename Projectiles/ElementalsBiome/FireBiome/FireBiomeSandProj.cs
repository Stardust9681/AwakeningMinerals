...
namespace AwakeningMinerals.Projectiles.ElementalsBiome.FireBiome
{
	public class FireBiomeSandProj : ModProjectile
	{
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Fire Sand Ball");
		...
		public override void SetDefaults() {
			...
			tileType = ModContent.TileType<FireSandTile>();

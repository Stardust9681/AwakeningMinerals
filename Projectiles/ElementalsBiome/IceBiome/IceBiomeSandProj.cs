...
namespace AwakeningMinerals.Projectiles.ElementalsBiome.IceBiome
{
	public class IceBiomeSandProj : ModProjectile
	{
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Ice Sand Ball");
		...
		public override void SetDefaults() {
			...
			tileType = ModContent.TileType<IceSandTile>();

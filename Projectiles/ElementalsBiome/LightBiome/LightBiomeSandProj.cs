...
namespace AwakeningMinerals.Projectiles.ElementalsBiome.LightBiome
{
	public class LightBiomeSandProj : ModProjectile
	{
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Light Sand Ball");
		...
		public override void SetDefaults() {
			...
			tileType = ModContent.TileType<LightSandTile>();

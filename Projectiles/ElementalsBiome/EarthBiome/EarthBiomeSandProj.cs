...
namespace AwakeningMinerals.Projectiles.ElementalsBiome.EarthBiome
{
	public class EarthBiomeSandProj : ModProjectile
	{
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Earth Sand Ball");
		...
		public override void SetDefaults() {
			...
			tileType = ModContent.TileType<EarthSandTile>();

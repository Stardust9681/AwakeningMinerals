...
namespace AwakeningMinerals.Projectiles.ElementalsBiome.DeathBiome
{
	public class DeathBiomeSandProj : ModProjectile
	{
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Death Sand Ball");
		...
		public override void SetDefaults() {
			...
			tileType = ModContent.TileType<DeathSandTile>();

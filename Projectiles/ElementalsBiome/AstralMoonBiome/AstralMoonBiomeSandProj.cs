...
namespace AwakeningMinerals.Projectiles.ElementalsBiome.AstralMoonBiome
{
	public class AstralMoonBiomeSandProj : ModProjectile
	{
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Astral Moon Sand Ball");
		...
		public override void SetDefaults() {
			...
			tileType = ModContent.TileType<AstralMoonSandTile>();

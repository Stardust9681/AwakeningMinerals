...
namespace AwakeningMinerals.NPCs.ElementalBiome.IceBiome
{

	public class IceBasilisk : ModNPC
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Ice Basilisk");
		}
		...
		{
			Item.NewItem(npc.getRect(), ModContent.ItemType<Items.Ice.Stone.IceStone>(), Main.rand.Next(1, 6));
		}

		public override void OnHitPlayer(Player target, int damage, bool crit)
		{
			if (Main.rand.Next(3) == 0) {
				target.AddBuff(ModContent.BuffType<IceDebuff>(), 180);
			}
		}
	}
}
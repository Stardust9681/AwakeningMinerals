...
namespace AwakeningMinerals.NPCs.ElementalBiome.ThunderBiome
{

	public class ThunderBasilisk : ModNPC
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Thunder Basilisk");
		}
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			for (int i = 0; i < 10; i++)
			{
				int dustType = mod.DustType("ThunderDust");
		...
		{
			Item.NewItem(npc.getRect(), ModContent.ItemType<Items.Thunder.Stone.ThunderStone>(), Main.rand.Next(1, 6));
		}

		public override void OnHitPlayer(Player target, int damage, bool crit)
		{
			if (Main.rand.Next(3) == 0) {
				target.AddBuff(ModContent.BuffType<ThunderDebuff>(), 180);
			}
		}
	}
}
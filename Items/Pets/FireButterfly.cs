...
{
    public class FireButterfly : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Fire Butterfly");
            Tooltip.SetDefault("Summon a pet - Fire Butterfly.");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType("FireButterflyProj");
            item.buffType = mod.BuffType("FireButterflyBuff");

...
{
    public class LightButterfly : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Light Butterfly");
            Tooltip.SetDefault("Summon a pet - Light Butterfly.");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType("LightButterflyProj");
            item.buffType = mod.BuffType("LightButterflyBuff");

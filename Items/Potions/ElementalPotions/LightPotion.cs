...
{
    public class LightPotion : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Light Potion");
            Tooltip.SetDefault("Give Night vision buff and Spelunker buff");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.buffType = BuffType<Buffs.Potions.LightBuff>(); //Specify an existing buff to be applied when used.
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<Items.Plants.LightFlower>(), 1);

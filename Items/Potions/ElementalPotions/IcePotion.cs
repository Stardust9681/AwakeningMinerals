...
{
    public class IcePotion : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Ice Potion");
            Tooltip.SetDefault("Immunity to : Frozen - Frostburn - Chilled");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.buffType = BuffType<Buffs.Potions.IceBuff>(); //Specify an existing buff to be applied when used.
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<Items.Plants.IceFlower>(), 1);
